    ...
    return (
        <>
            <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between lg:space-x-10 py-10 px-4 md:px-8">
                <div className="">
                    <h1 className="text-5xl lg:text-6xl font-bold text-gray-900">Find Your <span className="text-Primary">Perfect</span> Cleaning Match!</h1>
                    ...
                    <div className="relative mt-4 lg:w-2/3">
                        ...
                        />
                        <button className="absolute right-2 top-1/2 transform -translate-y-1/2  text-white bg-Primary hover:scale-75 p-2 rounded-full transition duration-300">
                            <svg
